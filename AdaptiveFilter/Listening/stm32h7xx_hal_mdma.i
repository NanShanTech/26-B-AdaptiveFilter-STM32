...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_mdma.c" 2
# 150 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_mdma.c"
...
# 150 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_mdma.c" 2
...
HAL_StatusTypeDef HAL_MDMA_Init(MDMA_HandleTypeDef *hmdma)
{
  ...
  do{ (hmdma)->Lock = HAL_UNLOCKED; }while (0);


  hmdma->State = HAL_MDMA_STATE_BUSY;


  ((hmdma)->Instance->CCR &= ~(0x1UL << (0U)));


  while((hmdma->Instance->CCR & (0x1UL << (0U))) != 0U)
  {

    if((HAL_GetTick() - tickstart ) > 5U)
    {

      hmdma->ErrorCode = ((uint32_t)0x00000040U);
  ...
  hmdma->ErrorCode = ((uint32_t)0x00000000U);
...
HAL_StatusTypeDef HAL_MDMA_DeInit(MDMA_HandleTypeDef *hmdma)
{
  ...
  ((hmdma)->Instance->CIFCR = ((((uint32_t)(0x1UL << (0U))) | ((uint32_t)(0x1UL << (1U))) | ((uint32_t)(0x1UL << (2U))) | ((uint32_t)(0x1UL << (3U))) | ((uint32_t)(0x1UL << (4U))))));
...
HAL_StatusTypeDef HAL_MDMA_ConfigPostRequestMask(MDMA_HandleTypeDef *hmdma, uint32_t MaskAddress, uint32_t MaskData)
{
  ...
  do{ if((hmdma)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (hmdma)->Lock = HAL_LOCKED; } }while (0);

  if(HAL_MDMA_STATE_READY == hmdma->State)
  {

    if((hmdma->Instance->CTCR & (0x1UL << (30U))) == 0U)
    {
...
HAL_StatusTypeDef HAL_MDMA_UnRegisterCallback(MDMA_HandleTypeDef *hmdma, HAL_MDMA_CallbackIDTypeDef CallbackID)
{
  ...
  if(HAL_MDMA_STATE_READY == hmdma->State)
  {
    ...
    {
    case HAL_MDMA_XFER_CPLT_CB_ID:
      hmdma->XferCpltCallback = 0;
      break;

    case HAL_MDMA_XFER_BUFFERCPLT_CB_ID:
      hmdma->XferBufferCpltCallback = 0;
      break;

    case HAL_MDMA_XFER_BLOCKCPLT_CB_ID:
      hmdma->XferBlockCpltCallback = 0;
      break;

    case HAL_MDMA_XFER_REPBLOCKCPLT_CB_ID:
      hmdma->XferRepeatBlockCpltCallback = 0;
      break;

    case HAL_MDMA_XFER_ERROR_CB_ID:
      hmdma->XferErrorCallback = 0;
      break;

    case HAL_MDMA_XFER_ABORT_CB_ID:
      hmdma->XferAbortCallback = 0;
      break;
...
HAL_StatusTypeDef HAL_MDMA_LinkedList_CreateNode(MDMA_LinkNodeTypeDef *pNode, MDMA_LinkNodeConfTypeDef *pNodeConfig)
{
  ...
  pNode->CTCR = pNodeConfig->Init.SourceInc | pNodeConfig->Init.DestinationInc | pNodeConfig->Init.SourceDataSize | pNodeConfig->Init.DestDataSize | pNodeConfig->Init.DataAlignment| pNodeConfig->Init.SourceBurst | pNodeConfig->Init.DestBurst | ((pNodeConfig->Init.BufferTransferLength - 1U) << (18U)) | pNodeConfig->Init.TransferTriggerMode;
  ...
  if(pNodeConfig->Init.Request == ((uint32_t)0x40000000U))
  {
    pNode->CTCR |= (0x1UL << (30U));
  }
  ...
  if((pNodeConfig->Init.Request == ((uint32_t)0x40000000U)) || (pNodeConfig->PostRequestMaskAddress != 0U))
  {
    pNode->CTCR |= (0x1UL << (31U));
  }


  pNode->CBNDTR = ((pNodeConfig->BlockCount - 1U) << (20U)) & (0xFFFUL << (20U));


  if(pNodeConfig->Init.SourceBlockAddressOffset < 0)
  {
    pNode->CBNDTR |= (0x1UL << (18U));
  ...
  {
    pNode->CBNDTR |= (0x1UL << (19U));

    blockoffset = (uint32_t)(- pNodeConfig->Init.DestBlockAddressOffset);
    pNode->CBRUR |= ((blockoffset & 0x0000FFFFU) << (16U));
  }
  else
  {

    pNode->CBRUR |= ((((uint32_t)pNodeConfig->Init.DestBlockAddressOffset) & 0x0000FFFFU) << (16U));
  }
  ...
  if(pNodeConfig->Init.Request != ((uint32_t)0x40000000U))
  {
    ...
    pNode->CTBR = pNodeConfig->Init.Request & (0xFFUL << (0U));
...
HAL_StatusTypeDef HAL_MDMA_LinkedList_RemoveNode(MDMA_HandleTypeDef *hmdma, MDMA_LinkNodeTypeDef *pNode)
{
  ...
  if(HAL_MDMA_STATE_READY == hmdma->State)
  {
    ...
    else if(hmdma->FirstLinkedListNodeAddress == pNode)
    {
...
HAL_StatusTypeDef HAL_MDMA_Start(MDMA_HandleTypeDef *hmdma, uint32_t SrcAddress, uint32_t DstAddress, uint32_t BlockDataLength, uint32_t BlockCount)
{
  ...
  if(HAL_MDMA_STATE_READY == hmdma->State)
  {
    ...
    if(hmdma->Init.Request == ((uint32_t)0x40000000U))
    {

      hmdma->Instance->CCR |= (0x1UL << (16U));
    }
  }
  else
  {
...
HAL_StatusTypeDef HAL_MDMA_Start_IT(MDMA_HandleTypeDef *hmdma, uint32_t SrcAddress, uint32_t DstAddress, uint32_t BlockDataLength, uint32_t BlockCount)
{
  ...
  if(HAL_MDMA_STATE_READY == hmdma->State)
  {
    ...
    ((hmdma)->Instance->CCR |= ((((uint32_t)(0x1UL << (1U))) | ((uint32_t)(0x1UL << (2U))))));

    if(hmdma->XferBlockCpltCallback != 0)
    {

      ((hmdma)->Instance->CCR |= (((uint32_t)(0x1UL << (4U)))));
    }

    if(hmdma->XferRepeatBlockCpltCallback != 0)
    {

      ((hmdma)->Instance->CCR |= (((uint32_t)(0x1UL << (3U)))));
    }

    if(hmdma->XferBufferCpltCallback != 0)
    {

      ((hmdma)->Instance->CCR |= (((uint32_t)(0x1UL << (5U)))));
    }
...
HAL_StatusTypeDef HAL_MDMA_Abort(MDMA_HandleTypeDef *hmdma)
{
  ...
  {
    hmdma->ErrorCode = ((uint32_t)0x00000080U);
  ...
  else
  {
    ...
    ((hmdma)->Instance->CCR &= ~((((uint32_t)(0x1UL << (1U))) | ((uint32_t)(0x1UL << (2U))) | ((uint32_t)(0x1UL << (4U))) | ((uint32_t)(0x1UL << (3U))) | ((uint32_t)(0x1UL << (5U))))));
    ...
    ((hmdma)->Instance->CIFCR = ((((uint32_t)(0x1UL << (0U))) | ((uint32_t)(0x1UL << (1U))) | ((uint32_t)(0x1UL << (3U))) | ((uint32_t)(0x1UL << (2U))) | ((uint32_t)(0x1UL << (4U))))));
...
HAL_StatusTypeDef HAL_MDMA_PollForTransfer(MDMA_HandleTypeDef *hmdma, HAL_MDMA_LevelCompleteTypeDef CompleteLevel, uint32_t Timeout)
{
  ...
  levelFlag = ((CompleteLevel == HAL_MDMA_FULL_TRANSFER) ? ((uint32_t)(0x1UL << (1U))) : (CompleteLevel == HAL_MDMA_BUFFER_TRANSFER)? ((uint32_t)(0x1UL << (4U))) : (CompleteLevel == HAL_MDMA_BLOCK_TRANSFER) ? ((uint32_t)(0x1UL << (3U))) : ((uint32_t)(0x1UL << (2U))));
  ...
  while(((hmdma)->Instance->CISR & (levelFlag)) == 0U)
  {
    if((((hmdma)->Instance->CISR & (((uint32_t)(0x1UL << (0U))))) != 0U))
    {

      errorFlag = hmdma->Instance->CESR;

      if((errorFlag & (0x1UL << (7U))) == 0U)
      {

        hmdma->ErrorCode |= ((uint32_t)0x00000001U);
      }
      else
      {

        hmdma->ErrorCode |= ((uint32_t)0x00000002U);
      }

      if((errorFlag & (0x1UL << (9U))) != 0U)
      {

        hmdma->ErrorCode |= ((uint32_t)0x00000004U);
      }

      if((errorFlag & (0x1UL << (8U))) != 0U)
      {

        hmdma->ErrorCode |= ((uint32_t)0x00000008U);
      }

      if((errorFlag & (0x1UL << (10U))) != 0U)
      {

        hmdma->ErrorCode |= ((uint32_t)0x00000010U);
      }

      if((errorFlag & (0x1UL << (11U))) != 0U)
      {

        hmdma->ErrorCode |= ((uint32_t)0x00000020U);
      }

      (void) HAL_MDMA_Abort(hmdma);
...
# 1419 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_mdma.c"
  ...
  {
    ((hmdma)->Instance->CIFCR = (((uint32_t)(0x1UL << (4U)))));

  }
  else if(CompleteLevel == HAL_MDMA_BLOCK_TRANSFER)
  {
    ((hmdma)->Instance->CIFCR = ((((uint32_t)(0x1UL << (4U))) | ((uint32_t)(0x1UL << (3U))))));

  }
  else if(CompleteLevel == HAL_MDMA_REPEAT_BLOCK_TRANSFER)
  {
    ((hmdma)->Instance->CIFCR = ((((uint32_t)(0x1UL << (4U))) | ((uint32_t)(0x1UL << (3U))) | ((uint32_t)(0x1UL << (2U))))));
  }
  else if(CompleteLevel == HAL_MDMA_FULL_TRANSFER)
  {
    ((hmdma)->Instance->CIFCR = ((((uint32_t)(0x1UL << (2U))) | ((uint32_t)(0x1UL << (3U))) | ((uint32_t)(0x1UL << (4U))) | ((uint32_t)(0x1UL << (1U))))));
...
HAL_StatusTypeDef HAL_MDMA_GenerateSWRequest(MDMA_HandleTypeDef *hmdma)
{
  ...
  request_mode = hmdma->Instance->CTCR & (0x1UL << (30U));

  if((hmdma->Instance->CCR & (0x1UL << (0U))) == 0U)
  {
  ...
  else if(((hmdma->Instance->CISR & (0x1UL << (16U))) != 0U) || (request_mode == 0U))
  {

    hmdma->ErrorCode = ((uint32_t)0x00000100U);
...
void HAL_MDMA_IRQHandler(MDMA_HandleTypeDef *hmdma)
{
  ...
  generalIntFlag = 1UL << ((((uint32_t)hmdma->Instance - (uint32_t)(((MDMA_Channel_TypeDef *)((((0x40000000UL) + 0x12000000UL) + 0x0000UL) + 0x00000040UL))))/0x40U) & 0x1FU);
  if((((MDMA_TypeDef *)(((0x40000000UL) + 0x12000000UL) + 0x0000UL))->GISR0 & generalIntFlag) == 0U)
  {
    return;
  }
  ...
  if((((hmdma)->Instance->CISR & (((uint32_t)(0x1UL << (0U))))) != 0U))
  {
    if((((hmdma)->Instance->CCR & (((uint32_t)(0x1UL << (1U)))))) != 0U)
    {

      ((hmdma)->Instance->CCR &= ~(((uint32_t)(0x1UL << (1U)))));
      ...
      ((hmdma)->Instance->CIFCR = (((uint32_t)(0x1UL << (0U)))));
    }
  }


  if((((hmdma)->Instance->CISR & (((uint32_t)(0x1UL << (4U))))) != 0U))
  {
    if((((hmdma)->Instance->CCR & (((uint32_t)(0x1UL << (5U)))))) != 0U)
    {
  ...
  if((((hmdma)->Instance->CISR & (((uint32_t)(0x1UL << (3U))))) != 0U))
  {
    if((((hmdma)->Instance->CCR & (((uint32_t)(0x1UL << (4U)))))) != 0U)
    {

      ((hmdma)->Instance->CIFCR = (((uint32_t)(0x1UL << (3U)))));
  ...
  if((((hmdma)->Instance->CISR & (((uint32_t)(0x1UL << (2U))))) != 0U))
  {
    if((((hmdma)->Instance->CCR & (((uint32_t)(0x1UL << (3U)))))) != 0U)
    {

      ((hmdma)->Instance->CIFCR = (((uint32_t)(0x1UL << (2U)))));
  ...
  if((((hmdma)->Instance->CISR & (((uint32_t)(0x1UL << (1U))))) != 0U))
  {
    if((((hmdma)->Instance->CCR & (((uint32_t)(0x1UL << (2U)))))) != 0U)
    {
      ...
      ((hmdma)->Instance->CIFCR = (((uint32_t)(0x1UL << (1U)))));
  ...
  if(hmdma->ErrorCode != ((uint32_t)0x00000000U))
  {
    hmdma->State = HAL_MDMA_STATE_ABORT;
...
static void MDMA_SetConfig(MDMA_HandleTypeDef *hmdma, uint32_t SrcAddress, uint32_t DstAddress, uint32_t BlockDataLength, uint32_t BlockCount)
{
  ...
  (((hmdma->Instance->CBNDTR)) = ((((((hmdma->Instance->CBNDTR))) & (~((0x1FFFFUL << (0U))))) | ((BlockDataLength & (0x1FFFFUL << (0U)))))));


  (((hmdma->Instance->CBNDTR)) = ((((((hmdma->Instance->CBNDTR))) & (~((0xFFFUL << (20U))))) | (((BlockCount - 1U) << (20U)) & (0xFFFUL << (20U))))));


  ((hmdma)->Instance->CIFCR = (((uint32_t)(0x1UL << (0U))) | ((uint32_t)(0x1UL << (1U))) | (0x1UL << (2U)) | (0x1UL << (3U)) | (0x1UL << (4U))));
...
static void MDMA_Init(MDMA_HandleTypeDef *hmdma)
{
  ...
  hmdma->Instance->CTCR = hmdma->Init.SourceInc | hmdma->Init.DestinationInc | hmdma->Init.SourceDataSize | hmdma->Init.DestDataSize | hmdma->Init.DataAlignment | hmdma->Init.SourceBurst | hmdma->Init.DestBurst | ((hmdma->Init.BufferTransferLength - 1U) << (18U)) | hmdma->Init.TransferTriggerMode;
  ...
  if(hmdma->Init.Request == ((uint32_t)0x40000000U))
  {
    ...
    hmdma->Instance->CTCR |= ((0x1UL << (30U)) | (0x1UL << (31U)));
  }
  ...
  {
    hmdma->Instance->CBNDTR |= (0x1UL << (18U));
  ...
  {
    hmdma->Instance->CBNDTR |= (0x1UL << (19U));

    blockoffset = (uint32_t)(- hmdma->Init.DestBlockAddressOffset);
    hmdma->Instance->CBRUR |= ((blockoffset & 0x0000FFFFU) << (16U));
  }
  else
  {

    hmdma->Instance->CBRUR |= ((((uint32_t)hmdma->Init.DestBlockAddressOffset) & 0x0000FFFFU) << (16U));
  }
  ...
  if(hmdma->Init.Request != ((uint32_t)0x40000000U))
  {
    ...
    hmdma->Instance->CTBR = hmdma->Init.Request & (0xFFUL << (0U));
  }
  else
  {
    hmdma->Instance->CTBR = 0;
