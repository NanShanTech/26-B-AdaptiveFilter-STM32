...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  else if(tim_baseHandle->Instance==((TIM_TypeDef *) ((0x40000000UL) + 0x0000UL)))
  {
    ...
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->APB1LENR) |= ((0x1UL << (0U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->APB1LENR) & ((0x1UL << (0U)))); ((void)(tmpreg)); } while(0);
