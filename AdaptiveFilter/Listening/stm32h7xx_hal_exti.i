...
# 120 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_exti.c" 2
...
uint32_t HAL_EXTI_GetPending(const EXTI_HandleTypeDef *hexti, uint32_t Edge)
{
  ...
  linepos = (hexti->Line & 0x0000001FUL);
  maskline = (1UL << linepos);
# 770 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_exti.c"
  regaddr = (volatile uint32_t *)(&((EXTI_TypeDef *) (((0x40000000UL) + 0x18000000UL) + 0x0000UL))->PR1 + (0x04U * offset));
...
# 788 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_exti.c"
void HAL_EXTI_ClearPending(const EXTI_HandleTypeDef *hexti, uint32_t Edge)
{
  volatile uint32_t *regaddr;
  uint32_t maskline;
  ...
  offset = ((hexti->Line & ((0x00UL << 16U) | (0x01UL << 16U) | (0x02UL << 16U))) >> 16U);
  maskline = (1UL << (hexti->Line & 0x0000001FUL));
# 818 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_exti.c"
  regaddr = (volatile uint32_t *)(&((EXTI_TypeDef *) (((0x40000000UL) + 0x18000000UL) + 0x0000UL))->PR1 + (0x04U * offset));
