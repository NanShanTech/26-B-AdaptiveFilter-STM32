# 1 "../SignalProcess/long_fft/arm_cfft_f32_extra.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 344 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../SignalProcess/long_fft/arm_cfft_f32_extra.c" 2
# 29 "../SignalProcess/long_fft/arm_cfft_f32_extra.c"
...
# 29 "../SignalProcess/long_fft/arm_cfft_f32_extra.c" 2
...
void arm_cfft_f32_extra(
        ...
        uint8_t ifftFlag,
        uint8_t bitReverseFlag);
# 30 "../SignalProcess/long_fft/arm_cfft_f32_extra.c" 2
# 587 "../SignalProcess/long_fft/arm_cfft_f32_extra.c"
...
extern void arm_bitreversal_32_extra(
  ...
  const uint32_t * pBitRevTable);
# 758 "../SignalProcess/long_fft/arm_cfft_f32_extra.c"
...
# 1133 "../SignalProcess/long_fft/arm_cfft_f32_extra.c"
void arm_cfft_f32_extra(
  const arm_cfft_instance_f32_extra * S,
        float32_t * p1,
        uint8_t ifftFlag,
