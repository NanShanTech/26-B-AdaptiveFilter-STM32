...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c" 2
...
# 323 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c" 2
# 420 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c"
  ...
  if (hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    if (hi2c->XferSize > 0U)
    {
      ...
      I2C_TransferConfig(hi2c, DevAddress, (uint8_t)(hi2c->XferSize + 1U), xfermode,
                         (uint32_t)(0x80000000U | (0x1UL << (13U))));
    }
    else
    {
    ...
    while (hi2c->XferCount > 0U)
    {
      ...
      if ((hi2c->XferCount != 0U) && (hi2c->XferSize == 0U))
      {
        ...
        {
          hi2c->XferSize = 255U;
          I2C_TransferConfig(hi2c, DevAddress, (uint8_t)hi2c->XferSize, (0x1UL << (24U)),
                             (0x00000000U));
        }
        else
        {
          hi2c->XferSize = hi2c->XferCount;
          I2C_TransferConfig(hi2c, DevAddress, (uint8_t)hi2c->XferSize, (0x1UL << (25U)),
                             (0x00000000U));
        }
      }
    }
                                         ...
                                         uint16_t Size, uint32_t Timeout)
{
  ...
  if (hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    if (hi2c->XferCount > 255U)
    {
      hi2c->XferSize = 255U;
      I2C_TransferConfig(hi2c, DevAddress, (uint8_t)hi2c->XferSize, (0x1UL << (24U)),
                         (uint32_t)(0x80000000U | (0x1UL << (13U)) | (0x1UL << (10U))));
    }
    else
    {
      hi2c->XferSize = hi2c->XferCount;
                                         ...
                                         uint32_t Timeout)
{
  ...
  if (hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    if (hi2c->Init.NoStretchMode == (0x1UL << (17U)))
    {
    ...
    error = I2C_WaitOnFlagUntilTimeout(hi2c, (0x1UL << (4U)), RESET, Timeout, tickstart);
    ...
    if (error != HAL_OK)
    {
      ...
      if ((hi2c->ErrorCode == (0x00000004U)) && (tmpXferCount == 0U))
      {
...
# 1785 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c"
HAL_StatusTypeDef HAL_I2C_Master_Receive_IT(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint8_t *pData,
                                            uint16_t Size)
{
  uint32_t xfermode;
                                              ...
                                              uint16_t Size)
{
  ...
  if (hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    if (hi2c->XferSize > 0U)
    {
      ...
      if (dmaxferstatus == HAL_OK)
      {
        ...
        I2C_TransferConfig(hi2c, DevAddress, (uint8_t)(hi2c->XferSize + 1U),
                           xfermode, (uint32_t)(0x80000000U | (0x1UL << (13U))));
    ...
    else
    {
      ...
      I2C_TransferConfig(hi2c, DevAddress, (uint8_t)sizetoxfer, (0x1UL << (25U)),
                         (uint32_t)(0x80000000U | (0x1UL << (13U))));
...
# 2133 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c"
HAL_StatusTypeDef HAL_I2C_Master_Receive_DMA(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint8_t *pData,
                                             uint16_t Size)
{
  uint32_t xfermode;
...
# 2278 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c"
HAL_StatusTypeDef HAL_I2C_Slave_Transmit_DMA(I2C_HandleTypeDef *hi2c, uint8_t *pData, uint16_t Size)
{
  HAL_StatusTypeDef dmaxferstatus;
...
# 2414 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c"
HAL_StatusTypeDef HAL_I2C_Slave_Receive_DMA(I2C_HandleTypeDef *hi2c, uint8_t *pData, uint16_t Size)
{
  HAL_StatusTypeDef dmaxferstatus;
...
# 2523 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c"
HAL_StatusTypeDef HAL_I2C_Mem_Write(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint16_t MemAddress,
                                    uint16_t MemAddSize, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  uint32_t tickstart;
                                       ...
                                       uint16_t MemAddSize, uint8_t *pData, uint16_t Size)
{
  ...
  if (hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    else
    {
      ...
      hi2c->Memaddress = ((uint8_t)((uint16_t)((MemAddress) & (uint16_t)(0x00FFU))));
    }
...
# 3263 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c"
HAL_StatusTypeDef HAL_I2C_IsDeviceReady(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint32_t Trials,
                                        uint32_t Timeout)
{
  uint32_t tickstart;
  ...
  if (hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    do
    {
      ...
      hi2c->Instance->CR2 = (((hi2c->Init.AddressingMode) == (0x00000001U)) ? (uint32_t)((((uint32_t)(DevAddress) & ((0x3FFUL << (0U)))) | ((0x1UL << (13U))) | ((0x1UL << (25U)))) & (~(0x1UL << (10U)))) : (uint32_t)((((uint32_t)(DevAddress) & ((0x3FFUL << (0U)))) | ((0x1UL << (11U))) | ((0x1UL << (13U))) | ((0x1UL << (25U)))) & (~(0x1UL << (10U)))));
...
# 3418 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c"
HAL_StatusTypeDef HAL_I2C_Master_Seq_Transmit_IT(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint8_t *pData,
                                                 uint16_t Size, uint32_t XferOptions)
{
  uint32_t xfermode;
  ...
  if (hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    if ((hi2c->XferSize > 0U) && ((XferOptions == ((uint32_t)(0x00000000U))) || (XferOptions == ((uint32_t)(0x1UL << (25U))))))
    ...
    if ((XferOptions == ((uint32_t)(0x00000000U))) || (XferOptions == ((uint32_t)(0x1UL << (25U)))))
    {
...
# 3816 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c"
HAL_StatusTypeDef HAL_I2C_Master_Seq_Receive_DMA(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint8_t *pData,
                                                 uint16_t Size, uint32_t XferOptions)
{
  uint32_t xfermode;
                                                ...
                                                uint32_t XferOptions)
{
  ...
  if (((uint32_t)hi2c->State & (uint32_t)HAL_I2C_STATE_LISTEN) == (uint32_t)HAL_I2C_STATE_LISTEN)
  {
    ...
    tmp = (((((hi2c)->Instance->ISR) & ((0x1UL << (3U)))) == ((0x1UL << (3U)))) ? SET : RESET);
    if ((((uint8_t)(((hi2c)->Instance->ISR & (0x1UL << (16U))) >> 16U)) == (0x00000001U)) && (tmp != RESET))
    {
...
# 4082 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c"
HAL_StatusTypeDef HAL_I2C_Slave_Seq_Transmit_DMA(I2C_HandleTypeDef *hi2c, uint8_t *pData, uint16_t Size,
                                                 uint32_t XferOptions)
{
                                               ...
                                               uint32_t XferOptions)
{
  ...
  if (((uint32_t)hi2c->State & (uint32_t)HAL_I2C_STATE_LISTEN) == (uint32_t)HAL_I2C_STATE_LISTEN)
  {
    ...
    tmp = (((((hi2c)->Instance->ISR) & ((0x1UL << (3U)))) == ((0x1UL << (3U)))) ? SET : RESET);
    if ((((uint8_t)(((hi2c)->Instance->ISR & (0x1UL << (16U))) >> 16U)) == (0x00000000U)) && (tmp != RESET))
    {
...
# 4603 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c"
HAL_StatusTypeDef HAL_I2C_Master_Abort_IT(I2C_HandleTypeDef *hi2c, uint16_t DevAddress)
{
...
# 4667 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c"
void HAL_I2C_EV_IRQHandler(I2C_HandleTypeDef *hi2c)
{
...
# 4920 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c"
HAL_I2C_StateTypeDef HAL_I2C_GetState(const I2C_HandleTypeDef *hi2c)
{
                                           ...
                                           uint32_t ITSources)
{
  ...
  else if ((((((tmpITFlags) & (((0x1UL << (6U))) & (0x0001FFFFU))) == (((0x1UL << (6U))) & (0x0001FFFFU))) ? SET : RESET) == RESET) && ((((((tmpITFlags) & (((0x1UL << (1U))) & (0x0001FFFFU))) == (((0x1UL << (1U))) & (0x0001FFFFU))) ? SET : RESET) != RESET) && (((((ITSources) & ((0x1UL << (1U)))) == ((0x1UL << (1U)))) ? SET : RESET) != RESET)))
      ...
      else
      {
        ...
        if (hi2c->XferOptions != (0xFFFF0000U))
        {
          I2C_TransferConfig(hi2c, devaddress, (uint8_t)hi2c->XferSize,
                             hi2c->XferOptions, (0x00000000U));
        }
        else
        {
          I2C_TransferConfig(hi2c, devaddress, (uint8_t)hi2c->XferSize,
                             (0x1UL << (25U)), (0x00000000U));
        }
      }
    }
    else
...
static HAL_StatusTypeDef I2C_Mem_ISR_IT(struct __I2C_HandleTypeDef *hi2c, uint32_t ITFlags,
                                        uint32_t ITSources)
{
  uint32_t direction = (uint32_t)(0x80000000U | (0x1UL << (13U)));
  uint32_t tmpITFlags = ITFlags;
...

  {
    ...
    {
      direction = (uint32_t)(0x80000000U | (0x1UL << (13U)) | (0x1UL << (10U)));
    }
                                          ...
                                          uint32_t ITSources)
{
  ...
  else if ((((((tmpITFlags) & (((0x1UL << (4U))) & (0x0001FFFFU))) == (((0x1UL << (4U))) & (0x0001FFFFU))) ? SET : RESET) != RESET) && (((((ITSources) & ((0x1UL << (4U)))) == ((0x1UL << (4U)))) ? SET : RESET) != RESET))
...
# 5402 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c"
static HAL_StatusTypeDef I2C_Master_ISR_DMA(struct __I2C_HandleTypeDef *hi2c, uint32_t ITFlags,
                                            uint32_t ITSources)
{
  uint16_t devaddress;
                                         ...
                                         uint32_t ITSources)
{
  ...
  else if ((((((ITFlags) & (((0x1UL << (1U))) & (0x0001FFFFU))) == (((0x1UL << (1U))) & (0x0001FFFFU))) ? SET : RESET) != RESET) && (((((ITSources) & ((0x1UL << (1U)))) == ((0x1UL << (1U)))) ? SET : RESET) != RESET))
                                           ...
                                           uint32_t ITSources)
{
  ...
  else if ((((((ITFlags) & (((0x1UL << (4U))) & (0x0001FFFFU))) == (((0x1UL << (4U))) & (0x0001FFFFU))) ? SET : RESET) != RESET) && (((((ITSources) & ((0x1UL << (4U)))) == ((0x1UL << (4U)))) ? SET : RESET) != RESET))

  {
        ...
        (((((ITSources) & ((0x1UL << (15U)))) == ((0x1UL << (15U)))) ? SET : RESET) != RESET))
    {
      ...
      if (hi2c->hdmarx != 0)
      {
        ...
        {
          if (((((((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x010UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x028UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x040UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x058UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x070UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x088UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x0A0UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x0B8UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x010UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x028UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x040UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x058UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x070UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x088UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x0A0UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x0B8UL)))))? (((DMA_Stream_TypeDef *)(hi2c->hdmarx)->Instance)->NDTR) : (((BDMA_Channel_TypeDef *)(hi2c->hdmarx)->Instance)->CNDTR)) == 0U)
          {
            treatdmanack = 1U;
          }
        }
      ...
      if (hi2c->hdmatx != 0)
      {
        if (((((ITSources) & ((0x1UL << (14U)))) == ((0x1UL << (14U)))) ? SET : RESET) != RESET)
        {
          if (((((((hi2c->hdmatx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x010UL))) || (((hi2c->hdmatx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x028UL))) || (((hi2c->hdmatx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x040UL))) || (((hi2c->hdmatx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x058UL))) || (((hi2c->hdmatx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x070UL))) || (((hi2c->hdmatx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x088UL))) || (((hi2c->hdmatx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x0A0UL))) || (((hi2c->hdmatx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x0B8UL))) || (((hi2c->hdmatx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x010UL))) || (((hi2c->hdmatx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x028UL))) || (((hi2c->hdmatx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x040UL))) || (((hi2c->hdmatx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x058UL))) || (((hi2c->hdmatx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x070UL))) || (((hi2c->hdmatx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x088UL))) || (((hi2c->hdmatx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x0A0UL))) || (((hi2c->hdmatx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x0B8UL)))))? (((DMA_Stream_TypeDef *)(hi2c->hdmatx)->Instance)->NDTR) : (((BDMA_Channel_TypeDef *)(hi2c->hdmatx)->Instance)->CNDTR)) == 0U)
          {
            treatdmanack = 1U;
          }
        }
...
# 5834 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c"
static HAL_StatusTypeDef I2C_RequestMemoryWrite(I2C_HandleTypeDef *hi2c, uint16_t DevAddress,
                                                uint16_t MemAddress, uint16_t MemAddSize, uint32_t Timeout,
                                                uint32_t Tickstart)
{
...
static void I2C_ITSlaveCplt(I2C_HandleTypeDef *hi2c, uint32_t ITFlags)
{
  ...
  {
    I2C_Disable_IRQ(hi2c, (uint16_t)(0x8000U) | (uint16_t)(0x0001U) | (uint16_t)(0x0002U));
    hi2c->PreviousState = ((uint32_t)(HAL_I2C_MODE_NONE));
  }
  else
  {
  ...
  if (((((tmpcr1value) & ((0x1UL << (14U)))) == ((0x1UL << (14U)))) ? SET : RESET) != RESET)
  {
    ...
    if (hi2c->hdmatx != 0)
    {
      hi2c->XferCount = (uint16_t)((((((hi2c->hdmatx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x010UL))) || (((hi2c->hdmatx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x028UL))) || (((hi2c->hdmatx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x040UL))) || (((hi2c->hdmatx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x058UL))) || (((hi2c->hdmatx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x070UL))) || (((hi2c->hdmatx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x088UL))) || (((hi2c->hdmatx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x0A0UL))) || (((hi2c->hdmatx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x0B8UL))) || (((hi2c->hdmatx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x010UL))) || (((hi2c->hdmatx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x028UL))) || (((hi2c->hdmatx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x040UL))) || (((hi2c->hdmatx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x058UL))) || (((hi2c->hdmatx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x070UL))) || (((hi2c->hdmatx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x088UL))) || (((hi2c->hdmatx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x0A0UL))) || (((hi2c->hdmatx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x0B8UL)))))? (((DMA_Stream_TypeDef *)(hi2c->hdmatx)->Instance)->NDTR) : (((BDMA_Channel_TypeDef *)(hi2c->hdmatx)->Instance)->CNDTR));
    }
  }
  else if (((((tmpcr1value) & ((0x1UL << (15U)))) == ((0x1UL << (15U)))) ? SET : RESET) != RESET)
  {
    ...
    if (hi2c->hdmarx != 0)
    {
      hi2c->XferCount = (uint16_t)((((((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x010UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x028UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x040UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x058UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x070UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x088UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x0A0UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x0B8UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x010UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x028UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x040UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x058UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x070UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x088UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x0A0UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x0B8UL)))))? (((DMA_Stream_TypeDef *)(hi2c->hdmarx)->Instance)->NDTR) : (((BDMA_Channel_TypeDef *)(hi2c->hdmarx)->Instance)->CNDTR));
    }
  }
  else
  {
  ...
  if ((((((tmpITFlags) & (((0x1UL << (4U))) & (0x0001FFFFU))) == (((0x1UL << (4U))) & (0x0001FFFFU))) ? SET : RESET) != RESET) && (((((tmpcr1value) & ((0x1UL << (4U)))) == ((0x1UL << (4U)))) ? SET : RESET) != RESET))
...
static void I2C_DMASlaveReceiveCplt(DMA_HandleTypeDef *hdma)
{
  ...
  if ((((((((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x010UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x028UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x040UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x058UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x070UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x088UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x0A0UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x0B8UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x010UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x028UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x040UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x058UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x070UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x088UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x0A0UL))) || (((hi2c->hdmarx)->Instance) == ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x0B8UL)))))? (((DMA_Stream_TypeDef *)(hi2c->hdmarx)->Instance)->NDTR) : (((BDMA_Channel_TypeDef *)(hi2c->hdmarx)->Instance)->CNDTR)) == 0U) && (tmpoptions != (0xFFFF0000U)))
...
static void I2C_DMAError(DMA_HandleTypeDef *hdma)
{
  ...
  if (!((HAL_DMA_GetError(hdma) == (0x00000002U))) && (treatdmaerror != 0U))
  {
...
# 6960 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c"
static void I2C_DMAAbort(DMA_HandleTypeDef *hdma)
{
...
# 6990 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c"
static HAL_StatusTypeDef I2C_WaitOnFlagUntilTimeout(I2C_HandleTypeDef *hi2c, uint32_t Flag, FlagStatus Status,
                                                    uint32_t Timeout, uint32_t Tickstart)
{
  while ((((((hi2c)->Instance->ISR) & (Flag)) == (Flag)) ? SET : RESET) == Status)
  {
    ...
    if (Timeout != 0xFFFFFFFFU)
    {
      if (((HAL_GetTick() - Tickstart) > Timeout) || (Timeout == 0U))
      {
        if (((((((hi2c)->Instance->ISR) & (Flag)) == (Flag)) ? SET : RESET) == Status))
        {
          hi2c->ErrorCode |= (0x00000020U);
          hi2c->State = HAL_I2C_STATE_READY;
          hi2c->Mode = HAL_I2C_MODE_NONE;
...
# 7030 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c"
static HAL_StatusTypeDef I2C_WaitOnTXISFlagUntilTimeout(I2C_HandleTypeDef *hi2c, uint32_t Timeout,
                                                        uint32_t Tickstart)
{
...
# 7071 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c"
static HAL_StatusTypeDef I2C_WaitOnSTOPFlagUntilTimeout(I2C_HandleTypeDef *hi2c, uint32_t Timeout,
                                                        uint32_t Tickstart)
{
  while ((((((hi2c)->Instance->ISR) & ((0x1UL << (5U)))) == ((0x1UL << (5U)))) ? SET : RESET) == RESET)
  {
    ...
    if (((HAL_GetTick() - Tickstart) > Timeout) || (Timeout == 0U))
    {
      if (((((((hi2c)->Instance->ISR) & ((0x1UL << (5U)))) == ((0x1UL << (5U)))) ? SET : RESET) == RESET))
      {
        hi2c->ErrorCode |= (0x00000020U);
        hi2c->State = HAL_I2C_STATE_READY;
        hi2c->Mode = HAL_I2C_MODE_NONE;
...
# 7109 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c"
static HAL_StatusTypeDef I2C_WaitOnRXNEFlagUntilTimeout(I2C_HandleTypeDef *hi2c, uint32_t Timeout,
                                                        uint32_t Tickstart)
{
  HAL_StatusTypeDef status = HAL_OK;

  while (((((((hi2c)->Instance->ISR) & ((0x1UL << (2U)))) == ((0x1UL << (2U)))) ? SET : RESET) == RESET) && (status == HAL_OK))
  {
    ...
    if (((((((hi2c)->Instance->ISR) & ((0x1UL << (5U)))) == ((0x1UL << (5U)))) ? SET : RESET) == SET) && (status == HAL_OK))
    {
    ...
    {
      if (((((((hi2c)->Instance->ISR) & ((0x1UL << (2U)))) == ((0x1UL << (2U)))) ? SET : RESET) == RESET))
      {
        hi2c->ErrorCode |= (0x00000020U);
        hi2c->State = HAL_I2C_STATE_READY;
...
# 7186 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c"
static HAL_StatusTypeDef I2C_IsErrorOccurred(I2C_HandleTypeDef *hi2c, uint32_t Timeout, uint32_t Tickstart)
{
  ...
  if ((((itflag) & ((0x1UL << (4U)))) == ((0x1UL << (4U)))))
  {
    ...
    while (((((((hi2c)->Instance->ISR) & ((0x1UL << (5U)))) == ((0x1UL << (5U)))) ? SET : RESET) == RESET) && (status == HAL_OK))
    {
      ...
      if (Timeout != 0xFFFFFFFFU)
      {
        if (((HAL_GetTick() - tickstart) > Timeout) || (Timeout == 0U))
        {
          tmp1 = (uint32_t)(hi2c->Instance->CR2 & (0x1UL << (14U)));
          tmp2 = hi2c->Mode;


          if (((((((hi2c)->Instance->ISR) & ((0x1UL << (15U)))) == ((0x1UL << (15U)))) ? SET : RESET) != RESET) && (tmp1 != (0x1UL << (14U))) && (tmp2 != HAL_I2C_MODE_SLAVE))
          ...
          while ((((((hi2c)->Instance->ISR) & ((0x1UL << (5U)))) == ((0x1UL << (5U)))) ? SET : RESET) == RESET)
          {
            ...
            if ((HAL_GetTick() - tickstart) > (25U))
            {
              error_code |= (0x00000020U);
  ...
  if ((((itflag) & ((0x1UL << (8U)))) == ((0x1UL << (8U)))))
  {
    error_code |= (0x00000001U);
  ...
  if ((((itflag) & ((0x1UL << (10U)))) == ((0x1UL << (10U)))))
  {
    error_code |= (0x00000008U);
  ...
  if ((((itflag) & ((0x1UL << (9U)))) == ((0x1UL << (9U)))))
  {
    error_code |= (0x00000002U);
...
# 7327 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c"
static void I2C_TransferConfig(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint8_t Size, uint32_t Mode,
                               uint32_t Request)
{
  uint32_t tmp;
  ...
  tmp = ((uint32_t)(((uint32_t)DevAddress & (0x3FFUL << (0U))) | (((uint32_t)Size << (16U)) & (0xFFUL << (16U))) | (uint32_t)Mode | (uint32_t)Request) & (~0x80000000U));




  (((hi2c->Instance->CR2)) = ((((((hi2c->Instance->CR2))) & (~((((0x3FFUL << (0U)) | (0xFFUL << (16U)) | (0x1UL << (24U)) | (0x1UL << (25U)) | ((0x1UL << (10U)) & (uint32_t)(Request >> (31U - (10U)))) | (0x1UL << (13U)) | (0x1UL << (14U))))))) | (tmp))));



}
# 7356 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c"
static void I2C_Enable_IRQ(I2C_HandleTypeDef *hi2c, uint16_t InterruptRequest)
{
  uint32_t tmpisr = 0U;
...
# 7447 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c"
static void I2C_Disable_IRQ(I2C_HandleTypeDef *hi2c, uint16_t InterruptRequest)
{
  uint32_t tmpisr = 0U;
