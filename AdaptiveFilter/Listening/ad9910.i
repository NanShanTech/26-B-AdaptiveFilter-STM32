...
void Init_AD9910(void)
{
    ...
    HAL_GPIO_WritePin(((GPIO_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x1000UL)), ((uint16_t)0x0001), GPIO_PIN_RESET);
    HAL_GPIO_WritePin(((GPIO_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x0400UL)), ((uint16_t)0x0008), GPIO_PIN_RESET);
    HAL_GPIO_WritePin(((GPIO_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x0400UL)), ((uint16_t)0x0010), GPIO_PIN_RESET);
    HAL_GPIO_WritePin(((GPIO_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x0400UL)), ((uint16_t)0x0020), GPIO_PIN_RESET);
    HAL_GPIO_WritePin(((GPIO_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x0C00UL)), ((uint16_t)0x0080), GPIO_PIN_RESET);
    HAL_GPIO_WritePin(((GPIO_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x1000UL)), ((uint16_t)0x0010), GPIO_PIN_RESET);
    HAL_GPIO_WritePin(((GPIO_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x1000UL)), ((uint16_t)0x0002), GPIO_PIN_SET);
    HAL_Delay(5);
    HAL_GPIO_WritePin(((GPIO_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x1000UL)), ((uint16_t)0x0002), GPIO_PIN_RESET);

    HAL_GPIO_WritePin(((GPIO_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x1000UL)), ((uint16_t)0x0008), GPIO_PIN_RESET);
    txd_8bit(0x00);
    for (m = 0; m < 4; m++)
        txd_8bit(cfr1[m]);
    while (HAL_GPIO_ReadPin(((GPIO_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x1000UL)), ((uint16_t)0x0008)) != GPIO_PIN_SET)
        HAL_GPIO_WritePin(((GPIO_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x1000UL)), ((uint16_t)0x0008), GPIO_PIN_SET);
    ...
    HAL_GPIO_WritePin(((GPIO_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x1000UL)), ((uint16_t)0x0008), GPIO_PIN_RESET);
    while (HAL_GPIO_ReadPin(((GPIO_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x1000UL)), ((uint16_t)0x0008)) != GPIO_PIN_RESET)
        HAL_GPIO_WritePin(((GPIO_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x1000UL)), ((uint16_t)0x0008), GPIO_PIN_RESET);
...
void AD9910_DRG_FrePara_Set(uint32_t lowFre, uint32_t upFre, uint32_t posStep, uint32_t negStep, uint16_t posRate, uint16_t negRate)
{
    ...
    uint8_t DRL[] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
    uint8_t DRS[] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
    uint8_t DRR[] = {0x00, 0x00, 0x00, 0x00};
