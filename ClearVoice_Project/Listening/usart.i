...
# 41 "../Core/Src/usart.c"
  ...
  huart3.Init.ClockPrescaler = 0x00000000U;
  huart3.AdvancedInit.AdvFeatureInit = 0x00000000U;
  if (HAL_UART_Init(&huart3) != HAL_OK)
  {
    Error_Handler();
  }
  if (HAL_UARTEx_SetTxFifoThreshold(&huart3, 0x00000000U) != HAL_OK)
  {
    Error_Handler();
  }
  if (HAL_UARTEx_SetRxFifoThreshold(&huart3, 0x00000000U) != HAL_OK)
  {
    Error_Handler();
  }
...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  if(uartHandle->Instance==((USART_TypeDef *) ((0x40000000UL) + 0x4800UL)))
  {
    ...
    PeriphClkInitStruct.PeriphClockSelection = ((uint64_t)(0x00000002U));
    PeriphClkInitStruct.Usart234578ClockSelection = (0x00000000U);
    ...
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->APB1LENR) |= ((0x1UL << (18U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->APB1LENR) & ((0x1UL << (18U)))); ((void)(tmpreg)); } while(0);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  if(uartHandle->Instance==((USART_TypeDef *) ((0x40000000UL) + 0x4800UL)))
  {
    ...
    (((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->APB1LENR) &= ~ ((0x1UL << (18U)));





    HAL_GPIO_DeInit(((GPIO_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x0400UL)), ((uint16_t)0x0400)|((uint16_t)0x0800));
