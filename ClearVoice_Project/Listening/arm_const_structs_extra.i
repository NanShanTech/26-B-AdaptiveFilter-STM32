# 1 "../SignalProcess/long_fft/arm_const_structs_extra.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 344 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../SignalProcess/long_fft/arm_const_structs_extra.c" 2
...
# 2 "../SignalProcess/long_fft/arm_const_structs_extra.c" 2
...
# 3 "../SignalProcess/long_fft/arm_const_structs_extra.c" 2
...
const arm_cfft_instance_f32_extra arm_cfft_sR_f32_len16_extra = {
  16, twiddleCoefExtra_16, armBitRevIndexTableExtra16, ((uint16_t)20)
};
...
const arm_cfft_instance_f32_extra arm_cfft_sR_f32_len32_extra = {
  32, twiddleCoefExtra_32, armBitRevIndexTableExtra32, ((uint16_t)48)
};
...
const arm_cfft_instance_f32_extra arm_cfft_sR_f32_len64_extra = {
  64, twiddleCoefExtra_64, armBitRevIndexTableExtra64, ((uint16_t)56)
};
...
const arm_cfft_instance_f32_extra arm_cfft_sR_f32_len128_extra = {
  128, twiddleCoefExtra_128, armBitRevIndexTableExtra128, ((uint16_t)208)
};
...
const arm_cfft_instance_f32_extra arm_cfft_sR_f32_len256_extra = {
  256, twiddleCoefExtra_256, armBitRevIndexTableExtra256, ((uint16_t)440)
};
...
const arm_cfft_instance_f32_extra arm_cfft_sR_f32_len512_extra = {
  512, twiddleCoefExtra_512, armBitRevIndexTableExtra512, ((uint16_t)448)
};
...
const arm_cfft_instance_f32_extra arm_cfft_sR_f32_len1024_extra = {
  1024, twiddleCoefExtra_1024, armBitRevIndexTableExtra1024, ((uint16_t)1800)
};
...
const arm_cfft_instance_f32_extra arm_cfft_sR_f32_len2048_extra = {
  2048, twiddleCoefExtra_2048, armBitRevIndexTableExtra2048, ((uint16_t)3808)
};
...
const arm_cfft_instance_f32_extra arm_cfft_sR_f32_len4096_extra = {
  4096, twiddleCoefExtra_4096, armBitRevIndexTableExtra4096, ((uint16_t)4032)
};
...
const arm_cfft_instance_f32_extra arm_cfft_sR_f32_len8192_extra = {
  8192, twiddleCoefExtra_8192, armBitRevIndexTableExtra8192, ((uint16_t)14576)
};
...
const arm_cfft_instance_f32_extra arm_cfft_sR_f32_len16384_extra = {
  16384, twiddleCoefExtra_16384, armBitRevIndexTableExtra16384, ((uint16_t)31080)
};
