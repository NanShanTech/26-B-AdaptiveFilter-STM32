...
void AD9220_Init(uint16_t *adc_buffer, uint32_t buffer_length) {
    ...
    HAL_DMA_Start(&hdma_tim2_up, (uint32_t)&((GPIO_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x0800UL))->IDR, (uint32_t)adc_buffer, buffer_length);
